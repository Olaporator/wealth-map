...
export default function CommunityOrganizing() {
  ...
  const contractors = useMemo(() => getContractorsForEntity(ENTITIES.NP, 'community'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <ContractorWidget contractors={contractors} title="Community Organizing Services" entityLabel="NP Outreach" />
      </div>
    </div>
  );
}
