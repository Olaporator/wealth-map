...
export default function LandscapeConsulting() {
  ...
  const contractors = React.useMemo(() => getContractorsForEntity(ENTITIES.V2, 'landscape-consulting'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <ContractorWidget contractors={contractors} title="Landscape Services" entityLabel="V2 Landscaping" />
      </div>
    </div>
  );
}
