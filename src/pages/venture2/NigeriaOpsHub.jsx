...
export default function NigeriaOpsHub() {
  ...
  const contractors = useMemo(() => getContractorsForEntity(ENTITIES.V1, 'ops-hub'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <ContractorWidget contractors={contractors} title="Ops Hub Team & Services" entityLabel="Nigeria Operations" />
      </div>
    </div>
  );
}
