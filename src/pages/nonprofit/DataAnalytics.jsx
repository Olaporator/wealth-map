...
export default function DataAnalytics() {
  ...
  const contractors = useMemo(() => getContractorsForEntity(ENTITIES.NP, 'data-analytics'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <ContractorWidget contractors={contractors} title="Data & Analytics Services" entityLabel="NP Data" />
      </div>
    </div>
  );
}
