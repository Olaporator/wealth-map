      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-lg text-emerald-400 font-semibold">V2 Agro — Land, Real Estate & Agriculture</p>
          </div>
        </div>
        <p className="text-gray-400 text-sm mt-2 max-w-2xl">
          Agro, land, and property-holding entity funded by 15% of after-tax distributions. Farm income flows to V2 ($50K/yr from age 35, 3% growth). V2 sub-venture income starts at 36 ($25K base, 12% growth). Construction interest split 50/50 V2/personal. Offshore/Nigeria maintenance paid by V2. V2 pays 20% of ops hub costs. <span className="text-emerald-300">Now owns city rentals via a dedicated rental LLC (moved from V1 NimbusTech — S-Corps are a poor vehicle for rental real estate).</span> Houses Landscape Consulting, Garden App, Agro Equipment Leasing, Property Management, and City Rentals. Invested at 12% returns with $150K LOC revolving facility.
        </p>
      </div>
