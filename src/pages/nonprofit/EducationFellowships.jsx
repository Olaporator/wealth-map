...
export default function EducationFellowships() {
  ...
  const contractors = useMemo(() => getContractorsForEntity(ENTITIES.NP, 'education'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <ContractorWidget contractors={contractors} title="Education & Fellowship Services" entityLabel="NP Education" />
      </div>
    </div>
  );
}
