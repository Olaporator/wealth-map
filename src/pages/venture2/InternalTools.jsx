...
export default function InternalTools() {
  ...
  const contractors = useMemo(() => getContractorsForEntity(ENTITIES.V1, 'internal-tools'), []);
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <ContractorWidget contractors={contractors} title="Internal Tools Services" entityLabel="V1 Dev/IT" />
      </div>
    </div>
  );
}
